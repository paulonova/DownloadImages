...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Map<String, Bitmap>> {
    ...
    boolean networkOk;
    Map<String, Bitmap> mBitmapMaps; // to load the images..
    ...
    private BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            /** initialize my image loader here*/
            getSupportLoaderManager().initLoader(0, null,MainActivity.this).forceLoad(); // forceLoad() trigger the download
...
//      Code to manage sliding navigation drawer
    ...
    private void displayDataItems(String category) {
        ...
        if (mItemList != null) {
            mItemAdapter = new DataItemAdapter(this, mItemList, mBitmapMaps);
    ...
    public void onLoadFinished(Loader<Map<String, Bitmap>> loader, Map<String, Bitmap> data) {
        mBitmapMaps = data;
        displayDataItems(null); // null is a filter
    }
